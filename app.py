...
def checkbox_webhook():
    ...
    row = [
        ...
        get_value(data, "Please rate your level of agreement with the following items._e9_Column2"),
        get_value(data, "Please rate your level of agreement with the following items._d1_Column2"),
        get_value(data, "Please rate your level of agreement with the following items._e5_Column2"),
        get_value(data, "Please rate your level of agreement with the following items._h1_Column2"),
        get_value(data, "Please rate your level of agreement with the following items._i3_Column2"),
        get_value(data, "Please rate your level of agreement with the following items._i4_Column2"),
        get_value(data, "gender"),
        get_value(data, "race_1"),
        get_value(data, "race_2"),
        get_value(data, "race_3"),
        get_value(data, "race_4"),
        get_value(data, "race_5"),
        get_value(data, "race_6"),
        get_value(data, "race_7"),
